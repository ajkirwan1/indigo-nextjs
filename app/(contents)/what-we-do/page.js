...
console.log(whatWeDoData[0].title)
    ...
    <>
      ...
      <section className={classes.section1}>
        <WebItemComponent
          ...
          // paragraph1={whatWeDoData[0]["title"]}
        />
        ...
        <div className={classes.sectionContainer}>
          <div className={classes.paragraphWrapper}>
            ...
            <p>
              ...
              propositions based on investor profile as portfolio, budgets, lock
              up period, etc. ensuring reliable project plans aligned with
        ...
        <div className={classes.sectionContainer}>
          <div className={classes.paragraphWrapper}>
            ...
            <p>
              ...
              tailored to the specific needs and goals of clients or investors. 
            </p>
            <p>
      ...
      <section className={classes.section4}>
        <div className={classes.sectionContainer}>
          ...
          <div className={classes.paragraphWrapperRight}>
            ...
            <p>
              Access expert Legal & Notarial Services for your real estate needs
              through our trusted affiliates. Streamline transactions,
              contracts, and legal documentation with precision and confidence,
              ensuring seamless real estate processes from start to finish.
            </p>
          </div>
        </div>
        <section>
